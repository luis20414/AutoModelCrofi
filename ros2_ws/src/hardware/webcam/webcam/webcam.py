...
class WebcamPublisher(Node):
    def __init__(self):
        ...
        self.cam.set(cv2.CAP_PROP_FRAME_WIDTH, 320)  # Set width to 320 pixels, before 640
        self.cam.set(cv2.CAP_PROP_FRAME_HEIGHT, 240)  # Set height to 240 pixels, before 480
